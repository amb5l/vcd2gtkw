...
# This file is part of vcd2gtkw. vcd2gtkw is free software: you can            #
# redistribute it and/or modify it under the terms of the GNU Lesser General   #
# Public License as published by the Free Software Foundation, either version  #
# 3 of the License, or (at your option) any later version.                     #
# vcd2gtkw is distributed in the hope that it will be useful, but WITHOUT ANY  #
# WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS    #
# FOR A PARTICULAR PURPOSE. See the GNU Lesser General Public License for more #
# details. You should have received a copy of the GNU Lesser General Public    #
# License along with The Tyto Project. If not, see                             #
# https://www.gnu.org/licenses/.                                               #
################################################################################
# vcd2gtkw.sh
# This script creates a .gtkw (waveform save file) from a .vcd (value change
# dump). Waves are added in the order they are found in the VCD, which
# normally matches the order of port, signal declarations etc in the design
# source. Wave colours are cycled as the hierarchy levels are traversed.
# Arguments:
#  $1 : vcd filename
#  $2 : gtkw filename
